...
function renderPokemon(pokemon) {
  ...
  var imagesPokemon = document.createElement('img');
  imagesPokemon.setAttribute('src', pokemon.imageUrl);
  pokemonCard.appendChild(imagesPokemon);
